...
public class Teste2 {
  ...
  public void testE2() throws Exception {
    ...
    driver.findElement(By.name("empresa")).sendKeys("Prefeitura Carambeí");
    ...
    driver.findElement(By.name("cidade")).sendKeys("Carambeí");
    ...
    driver.findElement(By.name("descricao")).sendKeys("Organização");
